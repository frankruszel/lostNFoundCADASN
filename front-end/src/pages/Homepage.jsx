                    ...
                    </Grid>
                    {
                      isRelevantItems == true && relevantItems?.length > 0
                        ? <>
                          ...
                          <Grid container spacing={4} px={10} mb={10} ml={8.5} >
                            {
                              (relevantItems.length > 0) && relevantItems.slice(1).map((item, i) => {
                                return (
                                  <>
                                    <Grid item xs={12} md={6} lg={3.5} sx={{ height: 330, mb: 10 }} >
                  ...
                  init === false
                    ...
                    : <>
                      <Grid container direction={'column'} >
                        ...
                        <Box sx={{ flexGrow: 1, display: 'flex', justifyContent: 'center', mt: "05%", ml:3 }}>
                          <Box>
                            <Grid>
                      ...
                      </Grid>
                      {
                        isRelevantItems == true && relevantItems?.length > 0
                          ? <>
                            ...
                            <Grid container spacing={4} px={10} mb={10} ml={8.5} >
                              {
                                (relevantItems.length > 0) && relevantItems.map((item, i) => {
                                  return (
                                    <>
                                      <Grid item xs={12} md={6} lg={3.5} sx={{ height: 330, mb: 10 }} >
